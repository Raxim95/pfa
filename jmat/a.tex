Anıq emes integraldı esaplań: $\displaystyle\int \left( 10x^{4} + 7x^{6} - 3 \right)dx$ RRRRR $2x^5+x^7-3x+C$
...
Tiyindi eki márte taslaǵanda, keminde bir márte san tárepi túsiw itimallıǵın tabıń RRRRR $\frac{3}{4}$
